...
function cadastroEndereco(cliente) {
    const endereco = new endereco_1.default();
...
function cadastroDocumento(cliente) {
    ...
    while (adicionarDocumento) {
        const documento = new documento_1.default();
        console.log("=====================================");
        console.log("");
        console.log("1 - CPF");
        console.log("2 - RG");
        ...
        if (opcao === 1) {
            ...
            documento.tipo = tipoDocumento_1.TipoDocumento.RG;
        }
        else if (opcao === 3) {
            documento.tipo = tipoDocumento_1.TipoDocumento.Passaporte;
        }
        else {
            console.log("Opção inválida!");
            continue;
...
function cadastroDepedente(cliente) {
    let adicionarDependente = true;
    while (adicionarDependente) {
        const dependente = new cliente_1.default();
        ...
        dependente.telefone = cliente.telefone.map(t => t.clonar());
